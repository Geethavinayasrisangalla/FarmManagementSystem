...
public class ReportService : IReportService
{
    ...
    public async Task<DashboardViewModel> GetDashboardDataAsync() =>
        new DashboardViewModel
        {
            ...
            LowStockResources = await _db.Resources.CountAsync(r => r.Quantity <= 10),
            UpcomingHarvests = await _db.PlantingSchedules
                                            .CountAsync(ps => ps.ScheduledDate <= DateTime.Today.AddDays(30)
                                                           && ps.Status == "Scheduled"),
    ...
    public async Task<YieldAnalyticsViewModel> GetYieldAnalyticsAsync()
    {
        ...
        return new YieldAnalyticsViewModel
        {
            ...
            AverageYield = records.Any() ? records.Average(r => r.ActualYieldKg) : 0
        };
    }
    }
}
